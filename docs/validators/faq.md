...
- **Validator's Address**: `torquevaloper1-` address. This is the address used to identify your validator publicly. The private key associated with this address is used to bond, unbond, and claim rewards.
...
torqued tx staking create-validator
    --pubkey torquevalconspub1zcjduepqs5s0vddx5m65h5ntjzwd0x8g3245rgrytpds4ds7vdtlwx06mcesmnkzly
    --amount "2atorque"
    --from tmp
...
- **Tendermint Key**: This is a unique key used to sign block hashes. It is associated with a public key `torquevalconspub`.
    - Generated when the node is created with `torqued init`.
...
If you want to obtain coins for the testnet, you can do so by using the [faucet](https://faucet.torque.dev/).
