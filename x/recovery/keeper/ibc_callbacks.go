...
//  - sends over all Torque native tokens
...
func (k Keeper) OnRecvPacket(
	...
	// a sender's own account on Torque (sender == recipient)
	...
	k.bankKeeper.IterateAccountBalances(ctx, recipient, func(coin sdk.Coin) (stop bool) {
		...
		err = k.transferKeeper.SendTransfer(
			...
			recipient,                 // recipient is the address in the Torque chain
...
// the IBC denomination, i.e port and channel on Torque for the voucher. It
// returns an error if:
